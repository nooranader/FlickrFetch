...
/**
 * Created by Noora on 5/24/2016.
 */
public class PhotosUserAPI extends AsyncTask<String, Void, ArrayList<FlickrInfo>> {

    private OnTaskComplete listener;
    private ProgressDialog loginProgress;

    public PhotosUserAPI(OnTaskComplete listener, ProgressDialog dialog) {
    ...
    protected ArrayList<FlickrInfo> doInBackground(String... arg0) {
        ...
        String searchUser = arg0[0];
        String noOfPosts = arg0[1];

        try {
            //send request
            HttpClient client = new DefaultHttpClient();
            HttpGet request = new HttpGet("https://api.flickr.com/services/rest/?method=flickr.photos.search&tag_mode=any&extras=owner_name&user_id="+searchUser+"&per_page="+noOfPosts+"&nojsoncallback=1&format=json&api_key=0e5cda91c2f84110cd75e8f7562b351e");
